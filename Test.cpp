...
void main() {
    // --------------------------------------------------------- for BHR7p2 ----------------------------------------------------------------------------
    #ifdef BHR7P2
    // add units            body name      inb name            mass    inerx    inery   inerz   if geom length  joints name                                             joints axis                             body to joint               inb to joint                Noise
    cMMakerBHR.fnvAddBase   ("midbody",     {0.0, 0.0, 0.72},   0.0001, {0.0001,  0.0001,  0.0001},       0.16                                                                                                                                                       );
    cMMakerBHR.fnvAddPin    ("uppbody",     "midbody",          19.500, {0.6100,  0.3800,  0.3000}, 1,    -0.5,   "waist_yaw",                                            {0, 0, 1},                            { 0.042,  0.000, -0.296},   { 0.000,  0.000,  0.000},   1, 0.01 );
    cMMakerBHR.fnvAddPin    ("larm",        "uppbody",          1.500,  {0.0430,  0.0440,  0.0023}, 1,    0.3,    "left_arm",                                             {0, 1, 0},                            {-0.019,  0.000,  0.229},   { 0.000,  0.272,  0.115},   1, 0.01 );
    cMMakerBHR.fnvAddPin    ("rarm",        "uppbody",          1.500,  {0.0430,  0.0440,  0.0023}, 1,    0.3,    "right_arm",                                            {0, 1, 0},                            {-0.019,  0.000,  0.229},   { 0.000, -0.272,  0.115},   1, 0.01 );
    ...
    cMMakerBHR.fnvAddPin    ("lshank",      "lthigh",           1.800,  {0.0300,  0.0300,  0.0002}, 1,    0.32,   "left_leg_4",                                           {0, 1, 0},                            { 0.000,  0.000,  0.091},   {-0.014, -0.015, -0.219},   1, 0.01 );
    ...
    cMMakerBHR.fnvAddPin    ("rshank",      "rthigh",           1.800,  {0.0300,  0.0300,  0.0002}, 1,    0.32,   "right_leg_4",                                          {0, 1, 0},                            { 0.000,  0.000,  0.091},   {-0.014,  0.015, -0.219},   1, 0.01 );
    ...
    cMMakerBHR.fnvAddIMU    ("site_imu",    "uppbody",                                                                                                                                                                                      { 0.042,  0.000, -0.296},   1, 0.01 );
